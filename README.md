...
**Abdul** — Data Engineering Portfolio to demonstrate end-to-end data engineering skills in MySQL 8 — from raw CSV ingestion through dimensional modelling to window function analytics.
